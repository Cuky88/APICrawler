...
\IEEEPARstart{H}{ans} bla bal bal asd asgfas bla bal bal asd asgfas bla bal bal asd asgfas bla bal bal asd asgfas
...
bla bla bla bal bla bla bla bla bla
...
As [Halkidi, 2002]  suggests we used Jaccard-Coefficient for quality measurement. Jaccard measures the intersection of two quantities. In our case on quantity is the manual created cluster, lets name it C, the other one is the cluster set that k-means provides, lets name it K. In formal:
